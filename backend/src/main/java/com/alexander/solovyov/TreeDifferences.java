...
final public class TreeDifferences extends JFrame {
	...
	public TreeDifferences(String title, final TreeContext sourceContext, final TreeContext destContext,
		...
		final JSplitPane pane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, new JScrollPane(leftPane),
