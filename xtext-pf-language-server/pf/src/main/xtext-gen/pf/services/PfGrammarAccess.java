...
public class PfGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ProblemDiagramElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.ProblemDiagram");
	...
	public class NodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.Node");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PhenomenonElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.Phenomenon");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LinkElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.Link");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NodeTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.NodeType");
	...
	public class PhenomenonTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.PhenomenonType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		//enum PhenomenonType:
		//	UNSPECIFIED="phenomenon" | EVENT="event" | STATE="state" | VALUE="value";
		public EnumRule getRule() { return rule; }
	...
	public class LinkTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.LinkType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public PfGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tID = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.ID");
		this.tQUALIFIED_NAME = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "pf.Pf.QUALIFIED_NAME");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("pf.Pf".equals(grammar.getName())) {
				return grammar;
			}
