 ...
 */
package pf.ide.contentassist.antlr;
...
import pf.ide.contentassist.antlr.internal.InternalPfParser;
...
public class PfParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalPfParser createParser() {
		InternalPfParser result = new InternalPfParser(null);
